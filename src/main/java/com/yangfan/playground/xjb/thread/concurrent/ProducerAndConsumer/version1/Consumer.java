package com.yangfan.playground.xjb.thread.concurrent.ProducerAndConsumer.version1;

import java.util.Random;
import java.util.concurrent.BlockingQueue;

import com.yangfan.playground.xjb.thread.concurrent.ProducerAndConsumer.Goods;
